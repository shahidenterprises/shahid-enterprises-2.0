...
const products = [
  {
    ...
    features: [
      'Available calibers: 16/18mm to 28/30mm',
      'Salted and dry-salted variants',
      'Sorted by quality grades: A, AB, B, C',
  ...
  },
  {
    ...
    features: [
      ...
      'Available in salted form',
      'Processed under HACCP guidelines',
      'Ideal for snack sticks and slim sausages',
