      ...
      <div className={styles.footerGrid}>
        ...
        <div className={`${styles.footerCol} ${styles.footerAbout}`}>
          ...
          <div className={styles.socialLinks}>
            <a href="#" id="footer-social-fb" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            <a href="https://www.linkedin.com/company/shahidenterprises-official/" id="footer-social-li" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>
            </a>
            <a href="https://wa.me/923059312383" id="footer-social-wa" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
        ...
        <div className={styles.footerCol}>
          ...
          <div className={styles.footerLinks}>
            ...
            <Link href="/products" id="footer-link-products">Our Products</Link>
            <Link href="/certifications" id="footer-link-certifications">Certifications</Link>
            <Link href="/testimonials" id="footer-link-testimonials">Testimonials</Link>
          </div>
        </div>
        ...
        <div className={styles.footerCol}>
          <h4>Legal & Support</h4>
          <div className={styles.footerLinks}>
            <Link href="/faq" id="footer-link-faq">FAQ</Link>
            <Link href="/privacy-policy" id="footer-link-privacy">Privacy Policy</Link>
            <Link href="/terms" id="footer-link-terms">Terms & Conditions</Link>
            <Link href="/export-markets" id="footer-link-markets">Global Reach</Link>
